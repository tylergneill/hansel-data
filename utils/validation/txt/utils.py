...
CONFIG = {
    ...
    'unfamiliar_ngrams_default_filepath': 'utils/validation/txt/tmp/unfamiliar_ngrams.txt',
    'bracketless_content_default_filepath': 'utils/validation/txt/tmp/bracketless_content.txt',
