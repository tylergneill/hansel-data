...
class XMLToPlaintext:
    ...
    """
    def __init__(self, line_by_line=False):
        self.lines = [""]
...
def _detect_has_condensed_verses(xml_path: Path) -> bool:
    """Scan the XML file to detect if any <lg> elements use condensed verse format."""
...
def cli():
    ...
    try:
        converter = XMLToPlaintext(line_by_line=args.line_by_line)
