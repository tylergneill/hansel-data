...
<head>
    ...
    <style>
        body {{ font-family: sans-serif; max-width: 700px; margin: 2em 0; padding-left: 6em; padding-right: 1em; line-height: 1.6; }}
        @media (max-width: 600px) {{ body {{ padding-left: 3.0em; margin-top: 0; }} }}
