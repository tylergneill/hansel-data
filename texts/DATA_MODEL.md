...
but insofar as it supports them, they are secondary to main focus.

The goal is e-texts that are both useful for humans
(readable and easy to cross-reference with editions)
...
Brackets as found in the printed edition itself should be interpreted and re-represented in one of the above ways.  
